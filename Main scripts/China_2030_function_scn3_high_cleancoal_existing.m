...
function China_2030_function_scn3_high_cleancoal_existing(SD_IC)
...
% than 50% (total new and existing)
...
VOM_coal_exist = 6.845; VOM_CCGT_exist = 1.477; VOM_nuke_exist = 2.216; 
...
savename = ['D:\My Documents\Aust-China work\MATLAB\Results\scn_3_high\' ...
    'sum_China_',num2str(PV_wind_pen(1)),'PV_',num2str(PV_wind_pen(2)), ...
        'wind_scn3_high_full_cleancoal_existing.mat'];
save(savename)
save(savename)
