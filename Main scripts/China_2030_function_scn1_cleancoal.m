...
%------------------------- created 09/07/13 -------------------------------
function China_2030_function_scn1_cleancoal(SD_IC)
...
NOX_factor_coal = 2391; 
NOX_factor_CCGT = 439; 
NOX_factor_nuke = 0;
NOX_factor_IGCC = 182;
NOX_factor_coal_exist = 2391;
...
SO2_factor_coal = 6493; 
SO2_factor_CCGT = 49; 
SO2_factor_nuke = 0;
SO2_factor_IGCC = 8;
SO2_factor_coal_exist = 6493;
...
FOM_coal = 20658; FOM_CCGT = 41036; FOM_nuke = 153630; FOM_IGCC = 78365; 
FOM_coal_exist = 21745; FOM_CCGT_exist = 43013; FOM_nuke_exist = 153630;
...
HR_coal = 8.57; HR_CCGT = 6.00; HR_nuke = 9.73; HR_IGCC = 7.83;
HR_coal_exist = 8.62; HR_CCGT_exist = 6.43; HR_nuke_exist = 9.83; 
...
%%%%%
% LDC_sample = 5;
% VC_pu_with_exist = VC_pu_with_exist((1:5),:);
% random_RLDC = random_RLDC((1:5),:);
% random_annual_cap_cost_all = random_annual_cap_cost_all((1:5),:);
% random_annual_cap_cost_fossil = random_annual_cap_cost_fossil((1:5),:);
% Energy_random_RLDC = Energy_random_RLDC(1:5);
...
for u = 1:length(mean_energy_fossil)
    ...
    PM(u,:) = (PM_factor_with_exist .* mean_energy_fossil(u,:)) * 10^3; % g
end
...
savename = ['D:\My Documents\Aust-China work\MATLAB\Results\scn_1\' ...
    'sum_China_',num2str(PV_wind_pen(1)),'PV_',num2str(PV_wind_pen(2)), ...
        'wind_scn1_full_cleancoal.mat'];
save(savename)
