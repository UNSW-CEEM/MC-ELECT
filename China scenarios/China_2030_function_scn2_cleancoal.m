...
%------------------------- created 09/07/13 -------------------------------
function China_2030_function_scn2_cleancoal(SD_IC)
...
% Fixed O&M cost of each technology ($/MW/year). FOM of coal include
% investment in clean up cost 
...
% Heat rate of each technology (GJ/MWh). for coal efficiency accounts for
% clean up tech
...
savename = ['D:\My Documents\Aust-China work\MATLAB\Results\scn_2\' ...
    'sum_China_',num2str(PV_wind_pen(1)),'PV_',num2str(PV_wind_pen(2)), ...
        'wind_scn2_full_cleancoal.mat'];
save(savename)
save(savename)
