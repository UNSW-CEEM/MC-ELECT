...
%------------------------- created 09/07/13 -------------------------------
% IGCC is clean coal in this case
function China_2030_function_scn6_low_cleancoal(SD_IC)
...
plant_life_IGCC = 40; plant_life_PV = 20; plant_life_wind = 30;
plant_life_hydro = 40;

% Variable O&M cost ($/MWh) - VOM IGCC is for clean coal plus treatment
% costs
VOM_coal = 2.066; VOM_CCGT = 1.477; VOM_nuke = 2.216; VOM_IGCC = 6.736;
...
HR_coal = 8.57; HR_CCGT = 6.00; HR_nuke = 9.73; HR_IGCC = 9.0;
...
cap_cost_IGCC_all = random_cap_cost_all(:,1);
...
savename = ['D:\My Documents\Aust-China work\MATLAB\Results\scn_6_low\' ...
    'sum_China_',num2str(PV_wind_pen(1)),'PV_',num2str(PV_wind_pen(2)), ...
        'wind_scn6_low_full_cleancoal.mat'];
save(savename)
save(savename)
