...
%------------------------- created 09/07/13 -------------------------------
% In this case IGCC is clean coal
function China_2030_function_scn3_low_cleancoal(SD_IC)
...
HR_coal = 8.57; HR_CCGT = 6.00; HR_nuke = 9.73; HR_IGCC = 9;
...
savename = ['D:\My Documents\Aust-China work\MATLAB\Results\scn_3_low\' ...
    'sum_China_',num2str(PV_wind_pen(1)),'PV_',num2str(PV_wind_pen(2)), ...
        'wind_scn3_low_full_cleancoal.mat'];
save(savename)
save(savename)
