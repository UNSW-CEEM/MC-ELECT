...
function China_2030_function_scn6_high_cleancoal_existing(SD_IC)
...
savename = ['D:\My Documents\Aust-China work\MATLAB\Results\scn_6_high\' ...
    'sum_China_',num2str(PV_wind_pen(1)),'PV_',num2str(PV_wind_pen(2)), ...
        'wind_scn6_high_full_cleancoal_existing.mat'];
save(savename)
save(savename)
